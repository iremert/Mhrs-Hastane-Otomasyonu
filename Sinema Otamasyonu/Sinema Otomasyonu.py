...
from PyQt5.QtWidgets import QMessageBox,QHeaderView #table için
...
def side_menu():
    if ui1.side_menu == 0:
        ...
        ui1.animation1.setStartValue(37)
        ui1.animation1.setEndValue(95)
...
ui1.frame_5.mousePressEvent=side_menu_1
...
def şifre1():
    ...
    QTimer.singleShot(2000, lambda: ui6.lineEdit_4.setEchoMode(QLineEdit.Password))
    #ui3.lineEdit_4.setEchoMode(QLineEdit.Normal)
    #time.sleep(2)
    #ui3.lineEdit_4.setEchoMode(QLineEdit.Password)
...
def FilmEkle(): 
    try:
        ...
        if QMessageBox.Ok:
            cursor.execute("Insert into Filmler (Film_Adı,Yönetmen,Vizyon_Tarihi,Film_Süresi,Film_Türü,Oyuncular) values(?,?,?,?,?,?)",(Film_adı,Yönetmen,Vizyon_tarihi,Film_süresi,Film_türü,oyuncular))           
            connection.commit()
...
ui4.pushButton_3.clicked.connect(resimekle)
...
def seansekle():
    try:
        ...
        if QMessageBox.Ok:
         ...
         ui7.statusbar.showMessage("Önceden bu seans girilmiş, lütfen tekrardan deneyiniz!")           
def geridön():
    window7.close()
    window10.show()
...
def seanslistele():
    ui5.tableWidget_3.setHorizontalHeaderLabels(("Seans kodu","Film adı", "Film saati", "Film tarihi", "Salon adı"))
